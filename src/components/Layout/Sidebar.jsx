...
export default function Sidebar() {
  ...
  return (
    <aside className="w-52 flex flex-col h-screen fixed left-0 top-0 z-10" style={{ background: '#060d18', borderRight: '1px solid rgba(255,255,255,0.05)' }}>
      {/* Logo */}
            ...
            {journeys.map(j => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-all ${
                    isJourneyActive(j.id) ? 'bg-white/8 text-white' : 'text-gray-500 hover:text-gray-200 hover:bg-white/5'
                  }`}
                >
